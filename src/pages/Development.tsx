            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                <div className="p-5 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg border border-raizing-teal-900">
                  ...
                  <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Well-documented, tested code following industry standards</p>
                </div>
                <div className="p-5 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg border border-raizing-teal-900">
                  <h3 className="font-bold text-raizing-teal-900 dark:text-white mb-2 flex items-center gap-2">
                  ...
                  <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Built with security and compliance from the ground up</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <div
                key={index}
                className="animate-on-scroll opacity-0 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 p-8 rounded-xl border border-raizing-teal-900 hover:border-raizing-maroon-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
                style={{ animationDelay: `${index * 100}ms` }}
              >
