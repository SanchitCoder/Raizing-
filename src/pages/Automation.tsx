          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-raizing-teal-900 p-6 sm:p-8 lg:p-10 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 mt-6">
                <div className="flex items-start gap-3 sm:gap-4 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg">
                  <CheckCircle2 className="w-6 h-6 text-raizing-maroon-500 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-raizing-teal-900 dark:text-white mb-1">Seamless Integration</h3>
                    <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Works with your existing software and systems without disruption</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg">
                  <CheckCircle2 className="w-6 h-6 text-raizing-maroon-500 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-raizing-teal-900 dark:text-white mb-1">Quick Implementation</h3>
                    <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Deploy solutions in weeks, not months, with minimal business disruption</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg">
                  <CheckCircle2 className="w-6 h-6 text-raizing-maroon-500 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-raizing-teal-900 dark:text-white mb-1">Scalable Architecture</h3>
                    <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Grows with your business from startup to enterprise scale</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4 bg-raizing-cream-50 dark:bg-gray-900 transition-colors duration-300 rounded-lg">
                  <CheckCircle2 className="w-6 h-6 text-raizing-maroon-500 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-raizing-teal-900 dark:text-white mb-1">24/7 Monitoring</h3>
                    <p className="text-xs sm:text-sm text-raizing-teal-900 dark:text-white">Continuous monitoring and optimization for peak performance</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="animate-on-scroll opacity-0 bg-white dark:bg-gray-800 p-8 rounded-xl border border-raizing-teal-900 text-center hover:border-raizing-maroon-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
                style={{ animationDelay: `${index * 100}ms` }}
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 gap-4 sm:gap-6">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="animate-on-scroll opacity-0 bg-gradient-to-br from-raizing-cream-50 to-white p-6 rounded-xl border border-raizing-teal-900 hover:border-raizing-maroon-500/50 transition-all duration-300 hover:shadow-lg text-center"
                style={{ animationDelay: `${index * 100}ms` }}
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={index}
                className="animate-on-scroll opacity-0 bg-gradient-to-br from-raizing-cream-50 to-white p-6 rounded-xl border border-raizing-teal-900"
