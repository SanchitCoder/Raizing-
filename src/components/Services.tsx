...
export default function Services() {
  ...
  return (
    <section ref={sectionRef} className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-raizing-cream-50 dark:from-gray-900 to-raizing-teal-900/30 dark:to-gray-800/30">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-8 relative z-10">
                ...
                <h3 className="text-lg sm:text-xl sm:text-2xl font-bold text-raizing-teal-900 dark:text-white mb-3 group-hover:text-raizing-maroon-600 transition-colors duration-300">{service.title}</h3>
                <p className="text-raizing-teal-900 dark:text-white mb-4 sm:mb-6 leading-relaxed group-hover:text-raizing-teal-800 transition-colors duration-300">{service.description}</p>
      ...
      <div
        className={`fixed inset-0 z-50 flex items-center justify-center p-2 p-4 transition-all duration-300 ${
          isFormOpen
      ...
      >
        ...
        {/* Modal Content */}
        <div
          className={`relative w-full max-w-lg bg-white rounded-xl shadow-2xl transform transition-all duration-300 max-h-[95vh] max-h-[90vh] overflow-hidden flex flex-col ${
            isFormOpen
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-raizing-maroon-500 to-raizing-maroon-700 rounded-t-lg rounded-t-xl p-4 text-raizing-cream-200 flex-shrink-0">
            <div className="flex items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold mb-0.5 truncate">Request a Consultation</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded-lg border border-raizing-teal-900 focus:border-raizing-maroon-500 focus:ring-2 focus:ring-raizing-maroon-500/20 outline-none transition-all bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm rounded-lg border border-raizing-teal-900 focus:border-raizing-maroon-500 focus:ring-2 focus:ring-raizing-maroon-500/20 outline-none transition-all resize-none"
              ...
              {formStatus === 'success' && (
                <div className="p-3 bg-raizing-maroon-50 border border-raizing-maroon-200 rounded-lg text-raizing-maroon-800 text-center animate-fade-in-up">
                  <p className="font-semibold text-xs sm:text-sm mb-0.5">Thank you for your interest!</p>
