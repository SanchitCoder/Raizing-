...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-raizing-cream-50 dark:from-gray-900 via-white dark:via-gray-800 to-raizing-teal-900/30 dark:to-gray-800/30 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-6 mb-8 sm:mb-12 lg:mb-16 animate-on-scroll opacity-0">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-raizing-teal-900 dark:text-white mb-3 sm:mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          <div className="animate-on-scroll opacity-0">
            <div className="bg-gradient-to-br from-raizing-maroon-500 to-raizing-maroon-700 rounded-2xl text-raizing-cream-200 h-full relative overflow-hidden">
              {/* Background Image */}
              ...
              <div className="relative z-10 p-6 sm:p-8 lg:p-10">
                <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 mb-4 sm:mb-6">Contact Information</h3>
                <p className="text-raizing-cream-300 mb-4 sm:mb-6 mb-6 sm:mb-8 leading-relaxed text-xs sm:text-sm sm:text-base">
                ...
                <div className="mt-8 mt-12 pt-6 pt-8 border-t border-raizing-cream-200/20">
                  <div className="text-xs sm:text-sm text-raizing-cream-300 mb-3 sm:mb-4">Follow Us</div>
                  <div className="flex gap-3 sm:gap-4">
                    {['LinkedIn', 'Twitter', 'Facebook', 'Instagram'].map((social) => (
                      <button
                        key={social}
                        className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition-all duration-300 flex items-center justify-center text-xs sm:text-sm font-medium"
                      >
                        {social[0]}
                      </button>
                    ))}
          ...
          <div className="animate-on-scroll opacity-0" style={{ animationDelay: '200ms' }}>
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 lg:p-10 border border-raizing-teal-900 dark:border-gray-700 shadow-lg transition-colors duration-300">
              <div className="space-y-4 space-y-6">
                <div>
                  <label className="block text-xs sm:text-sm font-semibold text-raizing-teal-900 dark:text-white mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 sm:px-6 py-2 sm:py-3 rounded-lg border border-raizing-teal-900 dark:border-gray-600 bg-white dark:bg-gray-700 text-raizing-teal-900 dark:text-white focus:border-raizing-maroon-500 focus:ring-2 focus:ring-raizing-maroon-500/20 outline-none transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full px-4 sm:px-6 py-2 sm:py-3 rounded-lg border border-raizing-teal-900 dark:border-gray-600 bg-white dark:bg-gray-700 text-raizing-teal-900 dark:text-white focus:border-raizing-maroon-500 focus:ring-2 focus:ring-raizing-maroon-500/20 outline-none transition-all resize-none"
