      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-6 sm:space-y-8">
          {caseStudies.map((study, index) => (
            ...
            >
              <div className="relative bg-gradient-to-br from-raizing-cream-100 to-white rounded-xl sm:rounded-2xl border border-raizing-teal-900 overflow-hidden hover:border-raizing-maroon-500/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:scale-[1.01] group/card">
                    ...
                    <div className="flex-shrink-0 w-full lg:w-auto">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-3 sm:gap-4">
                        {study.results.map((result, idx) => (
                          <div
                            key={idx}
                            className="flex items-center gap-3 sm:gap-4 bg-white p-3 sm:p-4 rounded-lg sm:rounded-xl border border-raizing-teal-900 hover:border-raizing-maroon-500/50 transition-all duration-300 group-hover:shadow-lg hover:scale-105 hover:-translate-y-1 group/result"
                          >
                            <div className={`relative p-2 sm:p-3 bg-gradient-to-r ${study.color} rounded-lg text-raizing-cream-200 flex-shrink-0 group-hover/result:scale-110 group-hover/result:rotate-3 transition-all duration-300 shadow-lg`}>
