...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className="absolute -top-14 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-[10px] sm:text-xs px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50">
          Chat on WhatsApp
