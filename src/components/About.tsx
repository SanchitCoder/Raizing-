            ...
            >
              ...
              <div className="p-6 sm:p-8 relative z-10">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl sm:text-2xl font-bold text-raizing-teal-900 mb-3 sm:mb-4 group-hover:text-raizing-maroon-600 transition-colors duration-300">{service.title}</h3>
                  <p className="text-sm sm:text-base text-raizing-teal-900 leading-relaxed group-hover:text-raizing-teal-800 transition-colors duration-300">{service.description}</p>
                </div>
              </div>
            </div>
          ))}
